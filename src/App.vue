<template>
  <Layout>
    <!-- Escria aqui su codigo-->
    <form class="form-task" v-on:submit.prevent="createTask">
    <input type="text" class="form-task__input" placeholder="Add new task" v-model= "taskName"/>
    ...
    <div class="card-task" v-for="task in todoStore.tasks" v-bind:class="{'done': task.done}">
    <input 
    type="checkbox" 
